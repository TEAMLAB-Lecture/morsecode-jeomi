...
def get_cleaned_english_sentence(raw_english_sentence):
    ...
    return result
    # ==================================
#get_cleaned_english_sentence("GG GT T T TEEEE")
...
def decoding_character(morse_character):
    ...
    for char, mos in morse_code_dict.items():
        if morse_character == mos:
            result = char
            break
...
def encoding_sentence(english_sentence):
    ...
    sentence = get_cleaned_english_sentence(english_sentence.strip())
    ...
    return result.strip()
    # ==================================
#encoding_sentence("GG GT T T TEEEE")
